...
@_ZTV6Square = unnamed_addr constant { [5 x i8*] } { [5 x i8*] [i8* null, i8* bitcast ({ i8*, i8*, i8* }* @_ZTI6Square to i8*), i8* bitcast (%class.Square* (%class.Square*)* @_ZN6SquareD1Ev to i8*), i8* bitcast (void (%class.Square*)* @_ZN6SquareD0Ev to i8*), i8* bitcast (double (%class.Square*, double)* @_ZN6Square4AreaEd to i8*)] }, align 8, !type !0, !type !1, !type !2, !type !3
...
@_ZTV6Circle = unnamed_addr constant { [5 x i8*] } { [5 x i8*] [i8* null, i8* bitcast ({ i8*, i8*, i8* }* @_ZTI6Circle to i8*), i8* bitcast (%class.Circle* (%class.Circle*)* @_ZN6CircleD1Ev to i8*), i8* bitcast (void (%class.Circle*)* @_ZN6CircleD0Ev to i8*), i8* bitcast (double (%class.Circle*, double)* @_ZN6Circle4AreaEd to i8*)] }, align 8, !type !0, !type !1, !type !4, !type !5
...
define double @_Z3gooP6Squared(%class.Square* %0, double %1) #1 {
  ...
  %10 = bitcast double (%class.Square*, double)** %9 to i8*
  %11 = call i1 @llvm.type.test(i8* %10, metadata !"_ZTS6Square")
  call void @llvm.assume(i1 %11)
  %12 = getelementptr inbounds double (%class.Square*, double)*, double (%class.Square*, double)** %9, i64 2
  %13 = load double (%class.Square*, double)*, double (%class.Square*, double)** %12, align 8
  %14 = call double %13(%class.Square* nonnull align 8 dereferenceable(8) %6, double %7)
  store double %14, double* %5, align 8
  %15 = load double, double* %5, align 8
  ret double %15
}
...
!2 = !{i64 16, !"_ZTS6Square"}
!3 = !{i64 32, !"_ZTSM6SquareFddE.virtual"}
!4 = !{i64 16, !"_ZTS6Circle"}
!5 = !{i64 32, !"_ZTSM6CircleFddE.virtual"}
...
!15 = !{!"Homebrew clang version 13.0.0"}
